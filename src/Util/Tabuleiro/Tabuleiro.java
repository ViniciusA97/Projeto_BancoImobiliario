...
public class Tabuleiro {
	...
	private Tabuleiro(int index) {
		...
		casas.add(fact.criaTerreno(index, "Rosa", "Av. Nossa Senhora de Copacabana", 260, 2, 10, 30, 90, 160, 250, 30,
				50));
		casas.add(new Empresas("Companhia Ferroviária", 200, 100, 50));
		casas.add(fact.criaTerreno(index, "Ciano", "Av. Brigadeiro Faria lima", 240, 20, 100, 300, 750, 925, 1100, 120,
				150));
	...
	public static Tabuleiro getInstance(int index) {
		try {
			...
			for (int i = 0; i < 40; i++) {
				instance.set(i, new Tabuleiro(i));
			}

			return instance.set(index, new Tabuleiro(index));
		}
	}
}
